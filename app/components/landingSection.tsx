...
<div className='flex flex-col gap-0 items-center justify-center w-full md:relative md:m-auto md:w-[80vw] md:max-w-[1300px] md:h-[100%]'>
        <div className='relative flex w-[65%] h-[120px] mx-auto md:absolute md:my-auto md:left-[5%] md:my-auto md:w-[95%] md:h-[500px] lg:h-[85%] '>
        ...
        <div className='text-center w-[90%] mx-auto md:text-left md:absolute md:bottom-55 md:left-0 md:w-100 lg:w-130 lg:bottom-15'>
